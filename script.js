...
document.getElementById('siBtn').addEventListener('click', function() {
    ...
    document.getElementById('messageContainer').innerHTML = 'Yeiiiiiiiiiiiiiii :3';
...
document.getElementById('noBtn').addEventListener('click', function() {
    switch (noButtonState) {
        case 0:
            ...
            document.getElementById('noBtn').innerHTML = '¿Estás segura? :c';
        ...
        case 3:
            ...
            document.getElementById('noBtn').innerHTML = '¿Segura segura segura segurísimaaa?';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
        ...
        case 4:
            ...
            document.getElementById('noBtn').innerHTML = 'Di que si por favor UnU';
            document.getElementById('noBtn').style.backgroundColor = '#F1330A';
...
document.getElementById('siBtn').addEventListener('click', function() {
    // Cambiar el color de fondo del body a rosa
    document.body.style.backgroundColor = '#F2C1D1'; // Rosa Tulipán
